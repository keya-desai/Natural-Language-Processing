...
class FFLM(nn.Module):
    ...
    def __init__(self, model, vocab, unk_symbol, init, lr, check_interval, seed,
        ...
        self.FF = FF(dim_input = wdim*self.nhis, dim_hidden = hdim, dim_output = self.V, num_layers = nlayers)
    ...
    def train_epochs(self, train_toks, val_toks, epochs):
        ...
        for ep in range(epochs):
            ...
            # --------------------------
            # Question 2.5 
            # tloss.append(total_loss / len(batch_inds) / T.size(0))
            # valperp.append(val_ppl)
            # trainperp.append(train_ppl)
            # --------------------------
        ...
        # print("Validation perplexity = ", valperp)
        # print("Training perplexity = ", trainperp)
...
def main(args):
    ...
    #         lm = FFLM(args.model, vocab, args.unk, args.init, l,
    #                   args.check_interval, args.seed, args.nhis, w, w,
    #                   args.nlayers, args.B)
    #         # print(lm)
    ...
    #                 print('%s' % z, end=' ')
    #             print()
    #         result.append(val_ppl)

    #     optimised_perplexity.append(result)

    
    # print("Optimised perplexity", optimised_perplexity)
