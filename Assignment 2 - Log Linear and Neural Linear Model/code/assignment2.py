...
def main(args):
    ...
    elif args.features == 'basic2suffix3':
        feature_extractor = util.basic_features2_suffix3
    elif args.features == 'basic1presuffix3':
        feature_extractor = util.basic_features1_prev_suffix3
    else:
